...
pub async fn get_user_preferences(auth_token: String) -> Result<UserPreferences, ServerFnError> {
    #[cfg(feature = "server")]
    {
...
pub async fn update_notification_preferences(
    ...
    #[cfg(feature = "server")]
    {
        ...
        let prefs = prefs_repo
            ...
            .await
            .map_err(|e| {
                ServerFnError::new(format!("Failed to update notification preferences: {}", e))
            })?;
