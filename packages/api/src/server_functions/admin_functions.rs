...
pub async fn get_classes() -> Result<Vec<serde_json::Value>, ServerFnError> {
    #[cfg(feature = "server")]
    {
        ...
        let state = crate::app_state::extract_server_state()
            .map_err(|e| ServerFnError::new(format!("state error: {}", e)))?;
        let repo = crate::repositories::class_section_repository::ClassSectionRepository::new(state.services.pool.clone());
...
pub async fn get_class_details(class_id: String) -> Result<serde_json::Value, ServerFnError> {
    #[cfg(feature = "server")]
    {
        ...
        // Get class section
        let class_repo = crate::repositories::class_section_repository::ClassSectionRepository::new(state.services.pool.clone());
        ...
        let enrollment_repo = crate::repositories::enrollment_repository::EnrollmentRepository::new(state.services.pool.clone());
        ...
        let teaching_repo = crate::repositories::teaching_assignment_repository::TeachingAssignmentRepository::new(state.services.pool.clone());
        ...
        // Get lectures
        let lecture_repo = crate::repositories::lecture_repository::LectureRepository::new(state.services.pool.clone());
...
pub async fn enroll_student(class_section_id: String, student_id: String) -> Result<serde_json::Value, ServerFnError> {
    #[cfg(feature = "server")]
    {
        use axum::extract::FromRequestParts;
        use axum::Extension;
        ...
        let student_repo = crate::repositories::student_repository::StudentRepository::new(state.services.pool.clone());
...
pub async fn unenroll_student(enrollment_id: String) -> Result<serde_json::Value, ServerFnError> {
    #[cfg(feature = "server")]
    {
        ...
        let class_school_id: Uuid = class.school_id.into();
        if class_school_id != school_id {
            return Err(ServerFnError::new("Forbidden: enrollment not in your school"));
        }
...
pub async fn get_unenrolled_students(class_section_id: String) -> Result<Vec<serde_json::Value>, ServerFnError> {
    #[cfg(feature = "server")]
    {
        use axum::extract::FromRequestParts;
        use axum::Extension;
...
pub async fn get_class_students(class_section_id: String) -> Result<Vec<serde_json::Value>, ServerFnError> {
    #[cfg(feature = "server")]
    {
        use axum::extract::FromRequestParts;
        use axum::Extension;
...
pub async fn get_recent_users(limit: Option<i64>) -> Result<serde_json::Value, ServerFnError> {
    #[cfg(feature = "server")]
    {
        ...
        // Get recent teachers
        let teacher_repo = crate::repositories::teacher_repository::TeacherRepository::new(state.services.pool.clone());
        ...
        // Get recent parents
        let parent_repo = crate::repositories::parent_repository::ParentRepository::new(state.services.pool.clone());
...
pub async fn get_reports(
    ...
    #[cfg(feature = "server")]
    {
        ...
        let state = crate::app_state::extract_server_state()
            .map_err(|e| ServerFnError::new(format!("state error: {}", e)))?;
        let report_repo = crate::repositories::report_repository::ReportRepository::new(state.services.pool.clone());
...
pub async fn get_admin_profile() -> Result<serde_json::Value, ServerFnError> {
    #[cfg(feature = "server")]
    {
        ...
        let profile_repo = crate::repositories::profile_repository::ProfileRepository::new(state.services.pool.clone());
        let profile = profile_repo
            .find_by_user_id(user_id.into())
            .await
            .ok();
...
pub async fn update_admin_profile(data: serde_json::Value) -> Result<serde_json::Value, ServerFnError> {
    #[cfg(feature = "server")]
    {
        use axum::extract::FromRequestParts;
        use axum::Extension;
        ...
        // Log the action
        let audit_repo = crate::repositories::audit_log_repository::AuditLogRepository::new(state.services.pool.clone());
