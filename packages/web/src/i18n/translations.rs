...
static TRANSLATIONS: LazyLock<HashMap<Locale, HashMap<&'static str, &'static str>>> = LazyLock::new(|| {
...
fn create_en_translations() -> HashMap<&'static str, &'static str> {
    ...
    m.insert("auth.email_not_confirmed", "Please confirm your email address");
    m.insert("auth.invalid_email", "Please enter a valid email address");
    m.insert("auth.password_too_short", "Password must be at least 8 characters");
    m.insert("auth.session_expired", "Your session has expired, please login again");
    m.insert("auth.unauthorized", "You don't have permission to access this resource");
    m.insert("auth.welcome_back", "Welcome Back");
    m.insert("auth.login_subtitle", "Enter your credentials to access your account");
    ...
    m.insert("materials.no_materials_desc", "Your teacher hasn't uploaded any materials for this class yet.");
    ...
    m.insert("materials.description_placeholder", "Briefly describe this material...");
    ...
    m.insert("parent.dashboard.sections.children_progress", "Children's Progress");
    ...
    m.insert("parent.dashboard.empty.no_children", "No children linked to your account");
    m.insert("parent.dashboard.empty.contact_admin", "Contact school administration to link your children.");

    m.insert("parent.dashboard.actions.view_reports", "View Reports");
    m.insert("parent.dashboard.actions.view_reports_desc", "See your children's academic reports.");
    m.insert("parent.dashboard.actions.view_classes", "View Classes");
    m.insert("parent.dashboard.actions.view_classes_desc", "See enrolled classes and schedules.");
    m.insert("parent.dashboard.actions.contact_teacher", "Contact Teacher");
    m.insert("parent.dashboard.actions.contact_teacher_desc", "Send a message to your child's teacher.");

    m.insert("parent.dashboard.coming_soon.chat", "Parent-Teacher Chat");
    m.insert("parent.dashboard.coming_soon.chat_desc", "Direct messaging with teachers");
    m.insert("parent.dashboard.coming_soon.calendar", "School Calendar");
    m.insert("parent.dashboard.coming_soon.calendar_desc", "View upcoming school events");
    m.insert("parent.dashboard.coming_soon.notifications", "Push Notifications");
    m.insert("parent.dashboard.coming_soon.notifications_desc", "Get alerts for important updates");
    ...
    m.insert("grades.description", "Check your grades and academic progress");
    ...
    m.insert("grades.track_progress", "Track your academic progress over time with detailed analytics");
    ...
    m.insert("grades.improvement_desc", "Your grades have improved over the last 3 months");
    ...
    m.insert("grades.coming_soon", "Detailed charts and personalized insights coming soon!");
    ...
    m.insert("classes.view_description", "View your enrolled classes and class materials");
    m.insert("classes.not_enrolled", "You haven't been enrolled in any classes yet.");
    ...
    m.insert("assignments.no_class_assignments", "No assignments for this class yet");
    m.insert("assignments.due_prefix", "Due: ");
    m.insert("assignments.description", "View and submit your assignments");
    ...
    m.insert("assignments.empty.check_back", "Check back later for new assignments");
    ...
    m.insert("assignments.personalization.info", "This assignment has been personalized based on your unique talents and learning style.");
    m.insert("assignments.personalization.badge", "Personalized for You");
    m.insert("assignments.personalization.details_title", "Personalization Details");
    m.insert("assignments.personalization.details", "Personalization Details");
    ...
    m.insert("assignments.work.placeholder", "Write your assignment response here...");
    m.insert("assignments.work.characters", " characters");
    m.insert("assignments.work.empty_error", "Please write something before submitting");
    m.insert("assignments.work.submit_error", "Failed to submit");
    m.insert("assignments.details.not_found", "Assignment not found");
    m.insert("assignments.ai_personalizing.title", "AI is Customizing Your Assignment");
    ...
    m.insert("students.no_enrolled_class", "No students enrolled in this class");
    ...
    m.insert("teachers.dashboard.no_assignments_created", "No assignments created yet");
    m.insert("teachers.dashboard.create_first_assignment", "Create your first assignment to get started");
    m.insert("teachers.dashboard.no_classes_assigned", "No classes assigned");
    ...
    m.insert("teachers.quick_actions.create_assignment_desc", "New task for your class");
    m.insert("teachers.quick_actions.grade_submissions", "Grade Submissions");
    m.insert("teachers.quick_actions.grade_submissions_desc", "Review and grade work");
    m.insert("teachers.quick_actions.schedule_lecture", "Schedule Lecture");
    m.insert("teachers.quick_actions.schedule_lecture_desc", "Plan your next session");
    m.insert("teachers.classes.manage_description", "Manage your classes and track student progress");
    m.insert("teachers.classes.no_classes_yet", "No classes yet");
    m.insert("teachers.classes.no_classes_assigned_desc", "You haven't been assigned to any classes.");
    ...
    m.insert("teachers.classes.enrolled_students_label", "Enrolled Students");
    ...
    m.insert("teachers.classes.assignments.total_assigned", "Total assigned: ");
    m.insert("teachers.assignments.manage_description", "Create and manage assignments for your classes");
    m.insert("teachers.assignments.delete_success", "Assignment deleted successfully");
    ...
    m.insert("teachers.assignments.no_assignments_title", "No Assignments Yet");
    m.insert("teachers.assignments.no_assignments_desc", "Create your first assignment to get started");
    m.insert("teachers.assignments.submission_progress", "Submission Progress");
    m.insert("teachers.assignments.delete_tooltip", "Delete assignment");
    m.insert("teachers.assignments.create.success", "Assignment created successfully!");
    m.insert("teachers.assignments.create.failed", "Failed to create: ");
    m.insert("teachers.assignments.create.title_label", "Assignment Title *");
    m.insert("teachers.assignments.create.title_placeholder", "e.g., Chapter 5 Quiz");
    m.insert("teachers.assignments.create.class_label", "Class *");
    m.insert("teachers.assignments.create.select_class", "Select a class...");
    m.insert("teachers.assignments.create.loading_classes", "Loading classes...");
    m.insert("teachers.assignments.create.due_date_label", "Due Date *");
    m.insert("teachers.assignments.create.description_label", "Assignment Description *");
    m.insert("teachers.assignments.create.description_placeholder", "Describe the assignment requirements...");
    m.insert("teachers.assignments.create.materials_label", "Reference Materials (for AI context)");
    m.insert("teachers.assignments.create.materials_selected", "material(s) selected");
    ...
    m.insert("teachers.assignments.create.create_btn", "Create Assignment");
    m.insert("teachers.assignments.details.title", "Assignment Details");
    m.insert("teachers.assignments.publish.success", "Assignment published successfully!");
    m.insert("teachers.assignments.publish.failed", "Failed to publish: ");
    m.insert("teachers.assignments.details.not_found", "Assignment not found");
    m.insert("teachers.assignments.details.failed_load", "Failed to load assignment");
    m.insert("teachers.assignments.details.created_label", "Created");
    m.insert("teachers.assignments.details.publish_btn", "Publish Assignment");
    m.insert("teachers.assignments.validation.required_fields", "Please fill in all required fields");
    m.insert("teachers.assignments.validation.invalid_date", "Invalid date format");

    // ==================== SCHOOL MANAGER ====================
    m.insert("school_manager.access_denied", "Access Denied");
    m.insert("school_manager.access_denied_desc", "You don't have permission to access the School Manager dashboard.");
    m.insert("school_manager.go_to_dashboard", "Go to Your Dashboard");
    
    m.insert("school_manager.recent_activity", "Recent Activity");
    m.insert("school_manager.recent_activity_desc", "Overview of latest platform updates");
    
    // Activity Mock Data Templates
    m.insert("school_manager.activity.new_student_added", "New student \"{0}\" was added.");
    m.insert("school_manager.activity.new_student_class_added", "New student \"{0}\" was added to {1}.");
    m.insert("school_manager.activity.schedule_updated", "Class schedule for \"{0}\" has been updated.");
    m.insert("school_manager.activity.report_generated", "Final report for {0} has been generated.");
    ...
    m.insert("school_manager.actions.add_user_desc", "Create new student, teacher, or parent account.");
    m.insert("school_manager.actions.create_class", "Create Class");
    m.insert("school_manager.actions.create_class_desc", "Add new class and assign a teacher.");
    m.insert("school_manager.actions.view_reports", "View Reports");
    m.insert("school_manager.actions.view_reports_desc", "Generate and view system reports.");
    m.insert("school_manager.actions.system_settings", "System Settings");
    m.insert("school_manager.actions.system_settings_desc", "Configure system preferences.");
    
    // ==================== SCHEDULE ====================
    m.insert("schedule.title", "Schedule");
    m.insert("schedule.description", "View your class schedule and important dates");
    ...
    m.insert("school_manager.users.description", "Manage students, teachers, and parents in your institution");
    ...
    m.insert("school_manager.users.manage_btn.students", "Manage Students");
    m.insert("school_manager.users.manage_btn.teachers", "Manage Teachers");
    ...
    m.insert("school_manager.users.directory.search_placeholder", "Search users...");
    ...
    m.insert("school_manager.users.messages.deactivate_success", "User deactivated successfully");
    m.insert("school_manager.users.messages.deactivate_fail", "Failed to deactivate user: ");
    m.insert("school_manager.users.messages.reactivate_success", "User reactivated successfully");
    m.insert("school_manager.users.messages.reactivate_fail", "Failed to reactivate user: ");
    m.insert("school_manager.users.messages.update_success", "User updated successfully");
    m.insert("school_manager.users.messages.update_fail", "Failed to update user: ");
    m.insert("school_manager.users.messages.load_error", "Error loading users: {e}");
    ...
    m.insert("school_manager.users.import_modal.title", "Bulk Import Users");
    m.insert("school_manager.users.import_modal.csv_title", "CSV Format Required");
    m.insert("school_manager.users.import_modal.csv_desc", "Upload a CSV file with columns: name, email, role (student/teacher/parent)");
    m.insert("school_manager.users.import_modal.drop_text", "Drop your CSV file here");
    m.insert("school_manager.users.import_modal.browse_text", "or click to browse files");
    m.insert("school_manager.users.import_modal.coming_soon", "Full bulk import functionality coming soon. For now, please add users individually.");
    ...
    m.insert("school_manager.users.export_modal.format_label", "Export Format");
    m.insert("school_manager.users.export_modal.options_label", "Options");
    m.insert("school_manager.users.export_modal.include_inactive", "Include inactive users");
    ...
    m.insert("school_manager.classes.description", "Manage classes, courses, and academic programs");
    ...
    m.insert("school_manager.classes.empty.desc", "Create your first class to get started managing courses and students.");
    m.insert("school_manager.classes.error.load_failed", "Failed to load classes");
    
    m.insert("school_manager.classes.create_modal.title", "Create New Class");
    m.insert("school_manager.classes.create_modal.class_name", "Class Name");
    m.insert("school_manager.classes.create_modal.class_name_placeholder", "e.g., Math 101 - Section A");
    m.insert("school_manager.classes.create_modal.term_placeholder", "e.g., Fall 2024");
    m.insert("school_manager.classes.create_modal.create_btn", "Create Class");
    m.insert("school_manager.classes.create_modal.creating", "Creating...");
    
    m.insert("school_manager.classes.detail_modal.title", "{class} - Manage Students");
    m.insert("school_manager.classes.detail_modal.add_student", "Add Student");
    m.insert("school_manager.classes.detail_modal.select_student", "Select a student...");
    m.insert("school_manager.classes.detail_modal.error_loading_students", "Error loading students");
    m.insert("school_manager.classes.detail_modal.enrolled_students", "Enrolled Students");
    m.insert("school_manager.classes.detail_modal.no_students", "No students enrolled yet");
    m.insert("school_manager.classes.detail_modal.failed_load_students", "Failed to load students");
    m.insert("school_manager.classes.detail_modal.enroll_btn", "Enroll");
    
    m.insert("school_manager.classes.errors.name_required", "Class name is required");
    m.insert("school_manager.classes.errors.subject_required", "Please select a subject");
    m.insert("school_manager.classes.errors.term_required", "Term is required");
    m.insert("school_manager.classes.errors.select_student_required", "Please select a student");
    m.insert("school_manager.classes.errors.enroll_failed", "Failed to enroll: ");
    m.insert("school_manager.classes.errors.remove_failed", "Failed to remove: ");

    // ==================== REPORTS ====================
    m.insert("school_manager.reports.title", "Reports & Analytics");
    m.insert("school_manager.reports.description", "Comprehensive insights and reports about your institution");
    m.insert("school_manager.reports.config.title", "Report Configuration");
    m.insert("school_manager.reports.config.export", "📥 Export");
    m.insert("school_manager.reports.config.generate", "📊 Generate Report");
    
    m.insert("school_manager.reports.types.class_performance", "Class Performance");
    m.insert("school_manager.reports.types.class_performance_desc", "Student grades and class stats");
    m.insert("school_manager.reports.types.teacher_workload", "Teacher Workload");
    m.insert("school_manager.reports.types.teacher_workload_desc", "Assignments and hours");
    m.insert("school_manager.reports.types.attendance", "Student Attendance");
    m.insert("school_manager.reports.types.attendance_desc", "Attendance records");
    m.insert("school_manager.reports.types.parent_engagement", "Parent Engagement");
    m.insert("school_manager.reports.types.parent_engagement_desc", "Portal activity metrics");
    
    m.insert("school_manager.reports.filters.class_label", "Class/Subject");
    ...
    m.insert("school_manager.reports.filters.all_teachers", "All Teachers");
    m.insert("school_manager.reports.filters.student_label", "Student (Optional)");
    m.insert("school_manager.reports.filters.all_students", "All Students");
    m.insert("school_manager.reports.filters.date_range_label", "Date Range");
    
    m.insert("school_manager.reports.filters.ranges.this_week", "This Week");
    m.insert("school_manager.reports.filters.ranges.this_month", "This Month");
    m.insert("school_manager.reports.filters.ranges.this_semester", "This Semester");
    m.insert("school_manager.reports.filters.ranges.this_year", "This Year");
    m.insert("school_manager.reports.filters.ranges.custom", "Custom Range");
    
    m.insert("school_manager.reports.class_performance.title", "Class Performance Report");
    m.insert("school_manager.reports.class_performance.subtitle_all", "All Classes • {date}");
    m.insert("school_manager.reports.class_performance.subtitle_filtered", "{filter} • {date}");
    m.insert("school_manager.reports.class_performance.export_pdf", "📥 PDF");
    m.insert("school_manager.reports.class_performance.export_excel", "📊 Excel");
    
    m.insert("school_manager.reports.stats.total_reports", "Total Reports");
    ...
    m.insert("school_manager.reports.chart.title", "Performance Chart Visualization");
    m.insert("school_manager.reports.chart.desc", "Grade distribution and trend analysis (Next Phase)");
    ...
    m.insert("school_manager.reports.table.empty", "No reports found for the selected filters");
    ...
    m.insert("school_manager.reports.table.unassigned_teacher", "Not assigned");
    m.insert("school_manager.reports.table.no_summary", "No summary");
    
    m.insert("school_manager.reports.sidebar.summary_title", "Report Summary");
    ...
    m.insert("school_manager.reports.sidebar.generated_label", "Generated:");
    m.insert("school_manager.reports.sidebar.just_now", "Just now");
    
    m.insert("school_manager.reports.sidebar.export_title", "Export Options");
    m.insert("school_manager.reports.sidebar.export_pdf", "📄 Export as PDF");
    m.insert("school_manager.reports.sidebar.export_excel", "📊 Export as Excel");
    m.insert("school_manager.reports.sidebar.export_csv", "📑 Export as CSV");
    m.insert("school_manager.reports.sidebar.export_image", "🖼️ Export as Image");
    
    m.insert("school_manager.reports.sidebar.schedule_title", "Schedule Reports");
    m.insert("school_manager.reports.sidebar.schedule_weekly", "⏰ Schedule Weekly");
    m.insert("school_manager.reports.sidebar.schedule_monthly", "📅 Schedule Monthly");
    m.insert("school_manager.reports.sidebar.schedule_quarterly", "📆 Schedule Quarterly");
    
    m.insert("school_manager.reports.workload.title", "Teacher Workload Report");
    m.insert("school_manager.reports.workload.analysis", "Teacher Workload Analysis");
    m.insert("school_manager.reports.workload.desc", "Teaching hours, class assignments, and workload distribution (Next Phase)");
    
    m.insert("school_manager.reports.attendance.title", "Student Attendance Report");
    m.insert("school_manager.reports.attendance.analytics", "Attendance Analytics");
    m.insert("school_manager.reports.attendance.desc", "Attendance patterns, trends, and exception reports (Next Phase)");
    
    m.insert("school_manager.reports.engagement.title", "Parent Engagement Report");
    m.insert("school_manager.reports.engagement.analytics", "Parent Portal Analytics");
    m.insert("school_manager.reports.engagement.desc", "Login frequency, feature usage, and engagement metrics (Next Phase)");

    // Dashboard Activity
    m.insert("school_manager.activity.new_student_added", "New student \"{0}\" was added.");

    // Requests
    m.insert("school_manager.requests.title", "Pending Profile Change Requests");
    m.insert("school_manager.requests.no_auth_token", "No auth token found");
    m.insert("school_manager.requests.success", "Request {0} successfully");
    m.insert("school_manager.requests.failure", "Failed to decide request: {0}");
    ...
    m.insert("school_manager.requests.error", "Error loading requests: {0}");
    m.insert("school_manager.requests.loading", "Loading requests...");

    // User Creation Hub
    m.insert("school_manager.users.creation.title", "User Creation Hub");
    m.insert("school_manager.users.creation.subtitle", "Create and manage student, teacher, and parent accounts");
    ...
    m.insert("school_manager.users.creation.personal_info", "Personal Information");
    m.insert("school_manager.users.creation.academic_info", "Academic Information");
    m.insert("school_manager.users.creation.professional_info", "Professional Information");
    m.insert("school_manager.users.creation.class_assignment", "Class Assignment");
    m.insert("school_manager.users.creation.student_association", "Student Association");
    ...
    m.insert("school_manager.users.creation.enrollment_date", "Enrollment Date *");
    m.insert("school_manager.users.creation.class_section", "Class Section");
    m.insert("school_manager.users.creation.academic_year", "Academic Year *");
    ...
    m.insert("school_manager.users.creation.qualifications", "Qualifications & Certifications");
    m.insert("school_manager.users.creation.assign_classes", "Assign Classes");
    m.insert("school_manager.users.creation.parent_id", "Parent ID *");
    m.insert("school_manager.users.creation.relationship", "Relationship *");
    m.insert("school_manager.users.creation.associated_students", "Associated Students *");
    ...
    m.insert("school_manager.users.creation.subjects.chemistry", "Chemistry");
    m.insert("school_manager.users.creation.subjects.biology", "Biology");
    m.insert("school_manager.users.creation.subjects.english", "English Literature");
    m.insert("school_manager.users.creation.subjects.history", "History");
    m.insert("school_manager.users.creation.subjects.cs", "Computer Science");
    
    m.insert("school_manager.users.creation.class_assignment_help", "Select classes to assign to this teacher. Hold Ctrl/Cmd to select multiple.");
    ...
    m.insert("school_manager.users.creation.placeholders.first_name", "Enter first name");
    m.insert("school_manager.users.creation.placeholders.last_name", "Enter last name");
    m.insert("school_manager.users.creation.placeholders.full_name", "Enter full name");
    m.insert("school_manager.users.creation.placeholders.relationship", "Enter relationship (e.g., Father)");

    // Sidebar Stats & Tips - Students
    m.insert("school_manager.users.creation.stats.student.total", "Total Students");
    m.insert("school_manager.users.creation.stats.student.new", "New This Week");
    m.insert("school_manager.users.creation.stats.student.pending", "Pending Approval");
    m.insert("school_manager.users.creation.stats.student.total_change", "+12 this month");
    m.insert("school_manager.users.creation.stats.student.new_change", "+3 vs last week");
    m.insert("school_manager.users.creation.stats.student.pending_change", "Need review");

    m.insert("school_manager.users.creation.tips.student.id", "Student IDs should follow the STU format (STU123456)");
    m.insert("school_manager.users.creation.tips.student.email", "Welcome emails are sent automatically to new students");
    m.insert("school_manager.users.creation.tips.student.parent", "Parent association is required for student accounts");

    // Sidebar Stats & Tips - Teachers
    m.insert("school_manager.users.creation.stats.teacher.total", "Total Teachers");
    m.insert("school_manager.users.creation.stats.teacher.active", "Active Classes");
    m.insert("school_manager.users.creation.stats.teacher.avg", "Avg Students/Class");
    m.insert("school_manager.users.creation.stats.teacher.total_change", "+2 this month");
    m.insert("school_manager.users.creation.stats.teacher.active_change", "All assigned");
    m.insert("school_manager.users.creation.stats.teacher.avg_change", "Optimal range");

    m.insert("school_manager.users.creation.tips.teacher.subjects", "Teachers can teach multiple subjects and grades");
    m.insert("school_manager.users.creation.tips.teacher.cert", "Certifications should be current and verifiable");
    m.insert("school_manager.users.creation.tips.teacher.assign", "Class assignments are made after account creation");

    // Sidebar Stats & Tips - Parents
    m.insert("school_manager.users.creation.stats.parent.total", "Total Parents");
    m.insert("school_manager.users.creation.stats.parent.linked", "Linked Students");
    m.insert("school_manager.users.creation.stats.parent.engagement", "Engagement Rate");
    m.insert("school_manager.users.creation.stats.parent.total_change", "+8 this month");
    m.insert("school_manager.users.creation.stats.parent.linked_change", "Some parents have multiple");
    m.insert("school_manager.users.creation.stats.parent.engagement_change", "Excellent");

    m.insert("school_manager.users.creation.tips.parent.multiple", "Each parent can be linked to multiple students");
    m.insert("school_manager.users.creation.tips.parent.access", "Parents have access to their children's academic progress");
    m.insert("school_manager.users.creation.tips.parent.mobile", "Parent accounts receive mobile notifications for important updates");

    // Activity
    m.insert("school_manager.users.creation.activity.student.created", "John Smith - Student account created");
    m.insert("school_manager.users.creation.activity.teacher.created", "Ms. Johnson - Teacher account created");
    m.insert("school_manager.users.creation.activity.parent.created", "Mary Davis - Parent account created");
    m.insert("school_manager.users.creation.activity.student.email", "Welcome emails sent to 5 new students");
    m.insert("school_manager.users.creation.activity.teacher.updated", "Class assignments updated for 3 teachers");
    m.insert("school_manager.users.creation.activity.parent.access", "Parent portal access granted to 2 parents");
    m.insert("school_manager.users.creation.activity.time.2h", "2 hours ago");
    m.insert("school_manager.users.creation.activity.time.5h", "5 hours ago");
    
    // Parent Children Section
    m.insert("parent.children.title", "My Children");
    m.insert("parent.children.desc", "Detailed information about your children's academic progress");
    m.insert("parent.children.error", "Failed to load children: {0}");
    m.insert("parent.children.empty.title", "No children linked");
    m.insert("parent.children.empty.desc", "Contact school administration to link your children to your account.");
    ...
    m.insert("parent.children.attendance.loading", "Loading attendance...");
    ...
    m.insert("parent.children.attendance.recent_absences", "Recent Absences");
    
    m.insert("parent.children.assignments.loading", "Loading assignments...");
    ...
    m.insert("parent.communication.desc", "Messages and updates from teachers and school administration");
    ...
    m.insert("parent.communication.compose.subject_ph", "Enter subject...");
    m.insert("parent.communication.compose.message", "Message:");
    m.insert("parent.communication.compose.message_ph", "Type your message here...");
    m.insert("parent.communication.compose.send", "Send Message");
    m.insert("parent.communication.compose.options.all_teachers", "All Teachers");
    ...
    m.insert("parent.reports.desc", "View detailed reports and analytics for your children");
    ...
    m.insert("parent.reports.filters.options.all_children", "All Children");
    m.insert("parent.reports.filters.options.academic", "Academic Performance");
    m.insert("parent.reports.filters.options.attendance", "Attendance Report");
    m.insert("parent.reports.filters.options.behavior", "Behavior Report");
    m.insert("parent.reports.filters.options.comprehensive", "Comprehensive Report");
    m.insert("parent.reports.filters.options.current_semester", "Current Semester");
    m.insert("parent.reports.filters.options.last_month", "Last Month");
    m.insert("parent.reports.filters.options.last_quarter", "Last Quarter");
    m.insert("parent.reports.filters.options.academic_year", "Academic Year");

    m.insert("parent.reports.available.title", "Available Reports");
    m.insert("parent.reports.available.academic.title", "Academic Performance");
    ...
    m.insert("parent.reports.available.attendance.title", "Attendance Report");
    m.insert("parent.reports.available.attendance.desc", "Detailed attendance records including absences, tardiness, and patterns");
    m.insert("parent.reports.available.behavior.title", "Behavior Report");
    m.insert("parent.reports.available.behavior.desc", "Behavior assessments, conduct records, and teacher feedback");
    m.insert("parent.reports.available.standardized.title", "Standardized Tests");
    m.insert("parent.reports.available.standardized.desc", "Standardized test scores and progress tracking");
    ...
    m.insert("school_manager.settings.description", "Manage your account and institution settings");
    ...
    m.insert("school_manager.settings.tabs.notifications", "Notifications");
    
    // General Settings
    m.insert("school_manager.settings.general.title", "General Settings");
    m.insert("school_manager.settings.general.loading", "Loading preferences...");
    ...
    m.insert("school_manager.settings.general.success", "Success! Settings saved.");
    m.insert("school_manager.settings.general.error", "Error: {0}");

    // Timezone Options
    m.insert("school_manager.settings.general.timezone.utc", "UTC");
    m.insert("school_manager.settings.general.timezone.et", "Eastern Time (ET)");
    m.insert("school_manager.settings.general.timezone.ct", "Central Time (CT)");
    m.insert("school_manager.settings.general.timezone.mt", "Mountain Time (MT)");
    m.insert("school_manager.settings.general.timezone.pt", "Pacific Time (PT)");
    m.insert("school_manager.settings.general.timezone.gmt", "London (GMT)");
    m.insert("school_manager.settings.general.timezone.cet", "Paris (CET)");
    m.insert("school_manager.settings.general.timezone.jst", "Tokyo (JST)");
    m.insert("school_manager.settings.general.timezone.gst", "Dubai (GST)");
    m.insert("school_manager.settings.general.timezone.aedt", "Sydney (AEDT)");

    // Time Format Options
    m.insert("school_manager.settings.general.time_format.24h", "24-hour (14:30)");
    m.insert("school_manager.settings.general.time_format.12h", "12-hour (2:30 PM)");

    // Notification Settings
    m.insert("school_manager.settings.notifications.title", "Notification Preferences");
    m.insert("school_manager.settings.notifications.loading", "Loading preferences...");
    m.insert("school_manager.settings.notifications.channels", "Notification Channels");
    m.insert("school_manager.settings.notifications.types", "Notification Types");
    m.insert("school_manager.settings.notifications.digest", "Email Digest");
    m.insert("school_manager.settings.notifications.save_btn", "Save Preferences");
    m.insert("school_manager.settings.notifications.success", "Success! Preferences saved.");
    m.insert("school_manager.settings.notifications.error", "Error: {0}");
    
    m.insert("school_manager.settings.notifications.email", "Email Notifications");
    m.insert("school_manager.settings.notifications.push", "Push Notifications");
    m.insert("school_manager.settings.notifications.in_app", "In-App Notifications");
    
    m.insert("school_manager.settings.notifications.user_reg", "User Registered");
    m.insert("school_manager.settings.notifications.user_reg_desc", "Notify when a new user joins the system");
    m.insert("school_manager.settings.notifications.class_created", "Class Created");
    m.insert("school_manager.settings.notifications.class_created_desc", "Notify when a new class is created");
    m.insert("school_manager.settings.notifications.assignment", "Assignment Submitted");
    m.insert("school_manager.settings.notifications.assignment_desc", "Notify when students submit assignments");
    m.insert("school_manager.settings.notifications.report", "Report Generated");
    m.insert("school_manager.settings.notifications.report_desc", "Notify when student reports are generated");
    m.insert("school_manager.settings.notifications.profile_change", "Profile Change Requests");
    m.insert("school_manager.settings.notifications.profile_change_desc", "Notify when profile change requests are submitted");
    m.insert("school_manager.settings.notifications.announcements", "System Announcements");
    m.insert("school_manager.settings.notifications.announcements_desc", "Receive important system updates");
    
    m.insert("school_manager.settings.notifications.digest.never", "Never");
    m.insert("school_manager.settings.notifications.digest.daily", "Daily Summary");
    m.insert("school_manager.settings.notifications.digest.weekly", "Weekly Summary");

    // Security Settings
    m.insert("school_manager.settings.security.title", "Change Password");
    m.insert("school_manager.settings.security.current_pwd", "Current Password");
    m.insert("school_manager.settings.security.new_pwd", "New Password");
    m.insert("school_manager.settings.security.confirm_pwd", "Confirm New Password");
    m.insert("school_manager.settings.security.update_btn", "Update Password");
    m.insert("school_manager.settings.security.mismatch", "New passwords do not match");
    m.insert("school_manager.settings.security.min_length", "Password must be at least 8 characters");
    m.insert("school_manager.settings.security.success", "Password changed successfully");
    m.insert("school_manager.settings.security.failure", "Failed to change password");

    // Profile Settings
    m.insert("school_manager.settings.profile.info_title", "Personal Information");
    m.insert("school_manager.settings.profile.loading", "Loading profile...");
    ...
    m.insert("school_manager.settings.profile.emergency", "Emergency Contact");
    ...
    m.insert("school_manager.settings.profile.role_admin", "Administrator");
    m.insert("school_manager.settings.profile.actions_title", "Profile Actions");
    m.insert("school_manager.settings.profile.request_change", "Request Profile Change");
    m.insert("school_manager.settings.profile.change_pwd", "Change Password");
    m.insert("school_manager.settings.profile.pwd_requirements", "Password requirements:");
    m.insert("school_manager.settings.profile.pwd_req_1", "At least 8 characters");
    m.insert("school_manager.settings.profile.pwd_req_2", "At least one uppercase letter");
    m.insert("school_manager.settings.profile.pwd_req_3", "At least one number");
    ...
    m.insert("school_manager.settings.profile.request_submitted", "Request submitted");
    m.insert("school_manager.settings.profile.log.updated", "Profile updated");
    m.insert("school_manager.settings.profile.log.submitted", "Request submitted");
    m.insert("school_manager.users.creation.placeholders.email_student", "student@school.edu");
    m.insert("school_manager.users.creation.placeholders.email_teacher", "teacher@school.edu");
    m.insert("school_manager.users.creation.placeholders.email_parent", "parent@example.com");
    m.insert("school_manager.users.creation.placeholders.phone", "(555) 123-4567");
    m.insert("school_manager.users.creation.placeholders.student_id", "STU001234");
    m.insert("school_manager.users.creation.placeholders.employee_id", "TCH001234");
    m.insert("school_manager.users.creation.placeholders.parent_id", "PAR001234");
    m.insert("school_manager.users.creation.placeholders.qualifications", "List degrees, certifications, and qualifications...");
    
    m.insert("school_manager.users.creation.btn.create_student", "Create Student Account");
    m.insert("school_manager.users.creation.btn.create_teacher", "Create Teacher Account");
    m.insert("school_manager.users.creation.btn.create_parent", "Create Parent Account");
    
    m.insert("school_manager.users.creation.options.select_grade", "Select Grade Level");
    m.insert("school_manager.users.creation.options.select_section", "Select Section");
    m.insert("school_manager.users.creation.options.select_dept", "Select Department");
    m.insert("school_manager.users.creation.options.loading_classes", "Loading classes...");
    m.insert("school_manager.users.creation.options.loading_students", "Loading students...");
    
    m.insert("school_manager.users.creation.success.student", "Student created successfully! Temporary password: {0}");
    m.insert("school_manager.users.creation.success.teacher", "Teacher created successfully! Temporary password: {0}");
    m.insert("school_manager.users.creation.success.parent", "Parent account created successfully. Temporary password: {0}");
    m.insert("school_manager.users.creation.error.parent", "Failed to create parent: {0}");
    
    m.insert("school_manager.users.creation.stats.title", "Current Statistics");
    m.insert("school_manager.users.creation.tips.title", "Quick Tips");
    m.insert("school_manager.users.creation.activity.title", "Recent Activity");
    ...
    // ==================== ERRORS ====================
    m.insert("errors.network", "Network error. Please check your connection.");
    m.insert("errors.server", "Server error. Please try again later.");
    m.insert("errors.not_found", "The requested resource was not found.");
    m.insert("errors.permission_denied", "You don't have permission to perform this action.");
    m.insert("errors.validation", "Please check your input and try again.");
    m.insert("errors.unknown", "An unexpected error occurred.");
    
    // ==================== VALIDATION ====================
    m.insert("validation.required", "This field is required");
    m.insert("validation.email_invalid", "Please enter a valid email address");
    ...
    m.insert("errors.access_denied_desc", "You don't have permission to access this page.");
...
fn create_fa_translations() -> HashMap<&'static str, &'static str> {
    ...
    m.insert("auth.password_too_short", "رمز عبور باید حداقل ۸ کاراکتر باشد");
    m.insert("auth.session_expired", "جلسه شما منقضی شده است، لطفاً دوباره وارد شوید");
    m.insert("auth.unauthorized", "شما اجازه دسترسی به این منبع را ندارید");
    ...
    m.insert("materials.no_materials_desc", "معلم شما هنوز منبعی برای این کلاس بارگذاری نکرده است.");
    ...
    m.insert("materials.description_placeholder", "توضیحات مختصر درباره این منبع...");
    ...
    m.insert("parent.dashboard.sections.children_progress", "پیشرفت فرزندان");
    ...
    m.insert("parent.dashboard.stats.status.family_avg", "میانگین خانواده");
    m.insert("parent.dashboard.stats.status.unread", "خوانده نشده");
    m.insert("parent.dashboard.stats.status.upcoming", "پیش‌رو");

    m.insert("parent.dashboard.empty.no_children", "هیچ فرزندی به حساب شما متصل نیست");
    m.insert("parent.dashboard.empty.contact_admin", "برای اتصال فرزندان خود با مدیریت مدرسه تماس بگیرید.");

    m.insert("parent.dashboard.actions.view_reports", "مشاهده کارنامه‌ها");
    m.insert("parent.dashboard.actions.view_reports_desc", "مشاهده گزارش‌های تحصیلی فرزندان");
    m.insert("parent.dashboard.actions.view_classes", "مشاهده کلاس‌ها");
    m.insert("parent.dashboard.actions.view_classes_desc", "مشاهده کلاس‌های ثبت‌نام شده و برنامه هفتگی");
    m.insert("parent.dashboard.actions.contact_teacher", "تماس با معلم");
    m.insert("parent.dashboard.actions.contact_teacher_desc", "ارسال پیام به معلم فرزندتان");

    m.insert("parent.dashboard.coming_soon.chat", "گفتگوی اولیا و مربیان");
    m.insert("parent.dashboard.coming_soon.chat_desc", "پیام‌رسانی مستقیم با معلمان");
    m.insert("parent.dashboard.coming_soon.calendar", "تقویم مدرسه");
    m.insert("parent.dashboard.coming_soon.calendar_desc", "مشاهده رویدادهای پیش‌رو");
    m.insert("parent.dashboard.coming_soon.notifications", "اعلان‌ها");
    m.insert("parent.dashboard.coming_soon.notifications_desc", "دریافت هشدارها برای بروزرسانی‌های مهم");
    ...
    m.insert("grades.description", "نمرات و پیشرفت تحصیلی خود را بررسی کنید");
    ...
    m.insert("grades.track_progress", "پیشرفت تحصیلی خود را با تحلیل‌های دقیق دنبال کنید");
    ...
    m.insert("grades.improvement_desc", "نمرات شما در ۳ ماه اخیر بهبود یافته است");
    ...
    m.insert("assignments.no_class_assignments", "تکلیفی برای این کلاس وجود ندارد");
    ...
    m.insert("assignments.empty.check_back", "بعداً برای تکالیف جدید مراجعه کنید");
    ...
    m.insert("assignments.personalization.info", "این تکلیف بر اساس استعدادها و سبک یادگیری منحصر به فرد شما شخصی‌سازی شده است.");
    m.insert("assignments.personalization.badge", "شخصی‌سازی شده برای شما");
    m.insert("assignments.personalization.details_title", "جزئیات شخصی‌سازی");
    ...
    m.insert("assignments.work.placeholder", "پاسخ تکلیف خود را اینجا بنویسید...");
    m.insert("assignments.work.characters", " کاراکتر");
    m.insert("assignments.work.empty_error", "لطفاً قبل از ارسال چیزی بنویسید");
    m.insert("assignments.work.submit_error", "خطا در ارسال");
    m.insert("assignments.details.not_found", "تکلیف یافت نشد");
    m.insert("assignments.ai_personalizing.title", "هوش مصنوعی در حال سفارشی‌سازی تکلیف شماست");
    m.insert("assignments.ai_personalizing.description", "لطفاً صبر کنید تا هوش مصنوعی این تکلیف را برای استعدادها و سبک یادگیری شما تنظیم کند...");
    ...
    m.insert("submissions.grade_label", "Grade");
    m.insert("submissions.review_description", "Review and grade student submissions");
    ...
    m.insert("submissions.caught_up_desc", "No pending submissions to grade");
    ...
    m.insert("submissions.validation_range", "Please enter a valid grade between 0 and 100");
    m.insert("submissions.save_failed", "Failed to save grade. Please try again.");
    m.insert("submissions.student_work_label", "Student's Work");
    m.insert("submissions.grade_range_label", "Grade (0-100)");
    m.insert("submissions.feedback_placeholder", "Great work! Consider improving...");
    ...
    m.insert("students.no_enrolled_class", "دانش‌آموزی در این کلاس ثبت‌نام نکرده است");
    ...
    m.insert("teachers.dashboard.no_assignments_created", "هنوز تکلیفی ایجاد نشده است");
    m.insert("teachers.dashboard.create_first_assignment", "اولین تکلیف خود را ایجاد کنید");
    m.insert("teachers.dashboard.no_classes_assigned", "کلاسی اختصاص داده نشده");
    ...
    m.insert("teachers.quick_actions.create_assignment_desc", "تکلیف جدید برای کلاس شما");
    m.insert("teachers.quick_actions.grade_submissions", "نمره‌دهی ارسال‌ها");
    m.insert("teachers.quick_actions.grade_submissions_desc", "بررسی و نمره‌دهی کارها");
    m.insert("teachers.quick_actions.schedule_lecture", "زمان‌بندی کلاس");
    m.insert("teachers.quick_actions.schedule_lecture_desc", "برنامه‌ریزی جلسه بعدی");
    m.insert("teachers.classes.manage_description", "مدیریت کلاس‌ها و پیگیری پیشرفت دانش‌آموزان");
    m.insert("teachers.classes.no_classes_yet", "هنوز کلاسی وجود ندارد");
    m.insert("teachers.classes.no_classes_assigned_desc", "شما هنوز به هیچ کلاسی اختصاص داده نشده‌اید.");
    ...
    m.insert("teachers.classes.enrolled_students_label", "دانش‌آموزان ثبت‌نام شده");
    ...
    m.insert("teachers.classes.assignments.to_grade_suffix", " برای نمره‌دهی");
    m.insert("teachers.classes.assignments.total_assigned", "کل اختصاص داده شده: ");
    m.insert("teachers.assignments.manage_description", "ایجاد و مدیریت تکالیف برای کلاس‌های شما");
    m.insert("teachers.assignments.delete_success", "تکلیف با موفقیت حذف شد");
    m.insert("teachers.assignments.delete_failed", "خطا در حذف: ");
    m.insert("teachers.assignments.create_new", "ایجاد تکلیف جدید");
    m.insert("teachers.assignments.no_assignments_title", "هنوز تکلیفی وجود ندارد");
    m.insert("teachers.assignments.no_assignments_desc", "اولین تکلیف خود را ایجاد کنید");
    m.insert("teachers.assignments.submission_progress", "پیشرفت ارسال‌ها");
    m.insert("teachers.assignments.delete_tooltip", "حذف تکلیف");
    m.insert("teachers.assignments.create.success", "تکلیف با موفقیت ایجاد شد!");
    m.insert("teachers.assignments.create.failed", "خطا در ایجاد: ");
    m.insert("teachers.assignments.create.title_label", "* عنوان تکلیف");
    m.insert("teachers.assignments.create.title_placeholder", "مثلاً: آزمون فصل ۵");
    m.insert("teachers.assignments.create.class_label", "* کلاس");
    m.insert("teachers.assignments.create.select_class", "یک کلاس انتخاب کنید...");
    m.insert("teachers.assignments.create.loading_classes", "در حال بارگذاری کلاس‌ها...");
    m.insert("teachers.assignments.create.due_date_label", "* مهلت تحویل");
    m.insert("teachers.assignments.create.description_label", "* توضیحات تکلیف");
    m.insert("teachers.assignments.create.description_placeholder", "الزامات تکلیف را شرح دهید...");
    m.insert("teachers.assignments.create.materials_label", "منابع مرجع (برای زمینه هوش مصنوعی)");
    m.insert("teachers.assignments.create.materials_selected", "منبع انتخاب شده");
    m.insert("teachers.assignments.create.ai_title", "شخصی‌سازی با هوش مصنوعی");
    ...
    m.insert("teachers.assignments.validation.required_fields", "لطفاً تمام فیلدهای اجباری را پر کنید");
    m.insert("teachers.assignments.validation.invalid_date", "فرمت تاریخ نامعتبر است");
    m.insert("teachers.students.description", "مشاهده پروفایل دانش‌آموزان و پیگیری پیشرفت آنها");
    m.insert("teachers.students.search_placeholder", "جستجوی دانش‌آموزان...");
    m.insert("teachers.students.no_students_found", "دانش‌آموزی یافت نشد");
    m.insert("teachers.students.no_students_desc", "شما هنوز دانش‌آموزی در کلاس‌های خود ندارید.");
    ...
    m.insert("teachers.students.loading_grades", "در حال بارگذاری نمرات...");
    m.insert("teachers.students.grades_failed", "خطا در بارگذاری: ");
    m.insert("teachers.students.no_grades", "هنوز تکلیف نمره‌گذاری شده‌ای وجود ندارد");
    m.insert("teachers.students.average_grade", "میانگین نمرات");

    // ==================== TEACHER SUBMISSIONS ====================
    m.insert("submissions.review_description", "بررسی و نمره‌دهی ارسال‌های دانش‌آموزان");
    ...
    m.insert("submissions.caught_up_desc", "تکلیف نمره‌گذاری نشده‌ای وجود ندارد");
    ...
    m.insert("submissions.validation_range", "لطفاً نمره‌ای معتبر بین ۰ تا ۱۰۰ وارد کنید");
    m.insert("submissions.save_failed", "خطا در ذخیره نمره. لطفاً دوباره تلاش کنید.");
    m.insert("submissions.student_work_label", "کار دانش‌آموز");
    m.insert("submissions.grade_range_label", "نمره (۰-۱۰۰)");
    m.insert("submissions.feedback_placeholder", "کار عالی بود! برای بهبود در نظر بگیرید...");
    ...
    m.insert("errors.permission_denied", "شما اجازه انجام این عملیات را ندارید.");
    m.insert("errors.validation", "لطفاً ورودی خود را بررسی کرده و دوباره تلاش کنید.");
    m.insert("errors.unknown", "خطای غیرمنتظره‌ای رخ داد.");
    
    // ==================== VALIDATION ====================
    m.insert("validation.required", "این فیلد اجباری است");
    m.insert("validation.email_invalid", "لطفاً یک آدرس ایمیل معتبر وارد کنید");
    m.insert("validation.min_length", "باید حداقل {0} کاراکتر باشد");
    m.insert("validation.max_length", "باید حداکثر {0} کاراکتر باشد");
    m.insert("school_manager.users.export_modal.export_btn", "خروجی گرفتن");

    // ==================== ACCESS & ERROR MESSAGES ====================
    m.insert("errors.access_denied", "دسترسی غیرمجاز");
    m.insert("errors.access_denied_desc", "شما اجازه دسترسی به این صفحه را ندارید.");
    ...
    m.insert("school_manager.classes.description", "مدیریت کلاس‌ها، دوره‌ها و برنامه‌های تحصیلی");
    ...
    m.insert("school_manager.classes.empty.desc", "اولین کلاس خود را ایجاد کنید تا مدیریت دوره‌ها و دانش‌آموزان را شروع کنید.");
    m.insert("school_manager.classes.error.load_failed", "خطا در بارگذاری کلاس‌ها");
    
    m.insert("school_manager.classes.create_modal.title", "ایجاد کلاس جدید");
    m.insert("school_manager.classes.create_modal.class_name", "نام کلاس");
    m.insert("school_manager.classes.create_modal.class_name_placeholder", "مثال: ریاضی ۱۰۱ - بخش الف");
    m.insert("school_manager.classes.create_modal.term_placeholder", "مثال: پاییز ۱۴۰۳");
    m.insert("school_manager.classes.create_modal.create_btn", "ایجاد کلاس");
    m.insert("school_manager.classes.create_modal.creating", "در حال ایجاد...");
    
    m.insert("school_manager.classes.detail_modal.title", "{class} - مدیریت دانش‌آموزان");
    m.insert("school_manager.classes.detail_modal.add_student", "افزودن دانش‌آموز");
    m.insert("school_manager.classes.detail_modal.select_student", "انتخاب دانش‌آموز...");
    m.insert("school_manager.classes.detail_modal.error_loading_students", "خطا در بارگذاری دانش‌آموزان");
    m.insert("school_manager.classes.detail_modal.enrolled_students", "دانش‌آموزان ثبت‌نام شده");
    m.insert("school_manager.classes.detail_modal.no_students", "هنوز دانش‌آموزی ثبت‌نام نشده است");
    m.insert("school_manager.classes.detail_modal.failed_load_students", "خطا در بارگذاری دانش‌آموزان");
    m.insert("school_manager.classes.detail_modal.enroll_btn", "ثبت‌نام");
    
    m.insert("school_manager.classes.errors.name_required", "نام کلاس الزامی است");
    m.insert("school_manager.classes.errors.subject_required", "لطفاً یک موضوع را انتخاب کنید");
    m.insert("school_manager.classes.errors.term_required", "ترم الزامی است");
    m.insert("school_manager.classes.errors.select_student_required", "لطفاً یک دانش‌آموز را انتخاب کنید");
    m.insert("school_manager.classes.errors.enroll_failed", "خطا در ثبت‌نام: ");
    m.insert("school_manager.classes.errors.remove_failed", "خطا در حذف: ");

    // ==================== REPORTS ====================
    m.insert("school_manager.reports.title", "گزارش‌ها و تحلیل‌ها");
    m.insert("school_manager.reports.description", "بینش جامع و گزارش‌های مربوط به موسسه شما");
    ...
    m.insert("school_manager.reports.types.class_performance", "عملکرد کلاس");
    m.insert("school_manager.reports.types.class_performance_desc", "نمرات دانش‌آموزان و آمار کلاس");
    m.insert("school_manager.reports.types.teacher_workload", "بار کاری معلم");
    m.insert("school_manager.reports.types.teacher_workload_desc", "تکالیف و ساعات کاری");
    m.insert("school_manager.reports.types.attendance", "حضور و غیاب دانش‌آموزان");
    m.insert("school_manager.reports.types.attendance_desc", "سوابق حضور و غیاب");
    m.insert("school_manager.reports.types.parent_engagement", "تعامل والدین");
    m.insert("school_manager.reports.types.parent_engagement_desc", "معیارهای فعالیت پورتال");
    ...
    m.insert("school_manager.reports.filters.student_label", "دانش‌آموز (اختیاری)");
    m.insert("school_manager.reports.filters.all_students", "همه دانش‌آموزان");
    m.insert("school_manager.reports.filters.date_range_label", "بازه زمانی");
    
    m.insert("school_manager.reports.filters.ranges.this_week", "این هفته");
    m.insert("school_manager.reports.filters.ranges.this_month", "این ماه");
    m.insert("school_manager.reports.filters.ranges.this_semester", "این ترم");
    ...
    m.insert("school_manager.reports.class_performance.title", "گزارش عملکرد کلاس");
    m.insert("school_manager.reports.class_performance.subtitle_all", "همه کلاس‌ها • {date}");
    m.insert("school_manager.reports.class_performance.subtitle_filtered", "{filter} • {date}");
    m.insert("school_manager.reports.class_performance.export_pdf", "📥 PDF");
    m.insert("school_manager.reports.class_performance.export_excel", "📊 اکسل");
    
    m.insert("school_manager.reports.stats.total_reports", "مجموع گزارش‌ها");
    ...
    m.insert("school_manager.reports.chart.desc", "توزیع نمرات و تحلیل روند (فاز بعدی)");
    ...
    m.insert("school_manager.reports.table.empty", "گزارشی برای فیلترهای انتخاب شده یافت نشد");
    m.insert("school_manager.reports.table.loading", "در حال بارگذاری گزارش‌ها...");
    m.insert("school_manager.reports.table.unknown_student", "ناشناس");
    m.insert("school_manager.reports.table.unassigned_teacher", "تعیین نشده");
    ...
    m.insert("school_manager.reports.sidebar.generated_label", "تولید شده:");
    m.insert("school_manager.reports.sidebar.just_now", "همین الان");
    
    m.insert("school_manager.reports.sidebar.export_title", "گزینه‌های خروجی");
    m.insert("school_manager.reports.sidebar.export_pdf", "📄 خروجی PDF");
    m.insert("school_manager.reports.sidebar.export_excel", "📊 خروجی اکسل");
    m.insert("school_manager.reports.sidebar.export_csv", "📑 خروجی CSV");
    m.insert("school_manager.reports.sidebar.export_image", "🖼️ خروجی تصویر");
    
    m.insert("school_manager.reports.sidebar.schedule_title", "زمان‌بندی گزارش‌ها");
    m.insert("school_manager.reports.sidebar.schedule_weekly", "⏰ زمان‌بندی هفتگی");
    m.insert("school_manager.reports.sidebar.schedule_monthly", "📅 زمان‌بندی ماهانه");
    m.insert("school_manager.reports.sidebar.schedule_quarterly", "📆 زمان‌بندی فصلی");
    
    m.insert("school_manager.reports.workload.title", "گزارش بار کاری معلم");
    m.insert("school_manager.reports.workload.analysis", "تحلیل بار کاری معلم");
    m.insert("school_manager.reports.workload.desc", "ساعات تدریس، تکالیف کلاس و توزیع بار کاری (فاز بعدی)");
    
    m.insert("school_manager.reports.attendance.title", "گزارش حضور و غیاب دانش‌آموز");
    m.insert("school_manager.reports.attendance.analytics", "تحلیل حضور و غیاب");
    m.insert("school_manager.reports.attendance.desc", "الگوهای حضور و غیاب، روندها و گزارش‌های استثنا (فاز بعدی)");
    
    m.insert("school_manager.reports.engagement.title", "گزارش تعامل والدین");
    m.insert("school_manager.reports.engagement.analytics", "تحلیل پورتال والدین");
    m.insert("school_manager.reports.engagement.desc", "فرکانس ورود، استفاده از امکانات و معیارهای تعامل (فاز بعدی)");

    // Dashboard Activity
    m.insert("school_manager.activity.new_student_added", "دانش‌آموز جدید \"{0}\" اضافه شد.");

    // Requests
    m.insert("school_manager.requests.title", "درخواست‌های تغییر پروفایل معلق");
    m.insert("school_manager.requests.no_auth_token", "توکن احراز هویت یافت نشد");
    m.insert("school_manager.requests.success", "درخواست با موفقیت {0} شد");
    m.insert("school_manager.requests.failure", "خطا در تصمیم‌گیری برای درخواست: {0}");
    m.insert("school_manager.requests.empty", "هیچ درخواست معلقی وجود ندارد");
    m.insert("school_manager.requests.requested_by", "درخواست شده توسط: {0}");
    m.insert("school_manager.requests.reject", "رد کردن");
    m.insert("school_manager.requests.approve", "تایید کردن");
    m.insert("school_manager.requests.error", "خطا در بارگذاری درخواست‌ها: {0}");
    m.insert("school_manager.requests.loading", "در حال بارگذاری درخواست‌ها...");
    ...
    m.insert("school_manager.actions.add_user_desc", "ایجاد حساب کاربری جدید برای دانش‌آموز، معلم یا والدین.");
    m.insert("school_manager.actions.create_class", "ایجاد کلاس");
    m.insert("school_manager.actions.create_class_desc", "افزودن کلاس جدید و تخصیص معلم.");
    m.insert("school_manager.actions.view_reports", "مشاهده گزارش‌ها");
    m.insert("school_manager.actions.view_reports_desc", "تولید و مشاهده گزارش‌های سیستم.");
    m.insert("school_manager.actions.system_settings", "تنظیمات سیستم");
    m.insert("school_manager.actions.system_settings_desc", "پیکربندی ترجیحات سیستم.");
    
    // Recent Activity
    m.insert("school_manager.recent_activity", "فعالیت‌های اخیر");
    m.insert("school_manager.recent_activity_desc", "نمای کلی از آخرین به‌روزرسانی‌های سیستم");
    m.insert("school_manager.activity.new_student_class_added", "دانش‌آموز جدید \"{0}\" به {1} اضافه شد.");
    m.insert("school_manager.activity.schedule_updated", "برنامه کلاسی \"{0}\" به‌روز شد.");
    m.insert("school_manager.activity.report_generated", "گزارش نهایی {0} تولید شد.");

    // Parent Children Section
    m.insert("parent.children.title", "فرزندان من");
    m.insert("parent.children.desc", "اطلاعات دقیق درباره پیشرفت تحصیلی فرزندان شما");
    m.insert("parent.children.error", "خطا در بارگذاری اطلاعات فرزندان: {0}");
    m.insert("parent.children.empty.title", "هیچ فرزندی متصل نیست");
    m.insert("parent.children.empty.desc", "برای اتصال فرزندان خود به حساب کاربری، با مدیریت مدرسه تماس بگیرید.");
    ...
    m.insert("parent.children.attendance.loading", "در حال بارگذاری حضور و غیاب...");
    ...
    m.insert("parent.children.assignments.loading", "در حال بارگذاری تکالیف...");
    ...
    m.insert("parent.communication.desc", "پیام‌ها و بروزرسانی‌ها از طرف معلمان و مدیریت مدرسه");
    ...
    m.insert("parent.communication.compose.subject_ph", "موضوع را وارد کنید...");
    m.insert("parent.communication.compose.message", "پیام:");
    m.insert("parent.communication.compose.message_ph", "پیام خود را اینجا بنویسید...");
    m.insert("parent.communication.compose.send", "ارسال پیام");
    m.insert("parent.communication.compose.options.all_teachers", "همه معلمان");
    ...
    m.insert("parent.reports.desc", "مشاهده گزارش‌ها و تحلیل‌های دقیق برای فرزندان شما");
    ...
    m.insert("parent.reports.filters.options.attendance", "گزارش حضور و غیاب");
    ...
    m.insert("parent.reports.filters.options.current_semester", "نیم‌سال جاری");
    m.insert("parent.reports.filters.options.last_month", "ماه گذشته");
    m.insert("parent.reports.filters.options.last_quarter", "سه ماهه گذشته");
    ...
    m.insert("parent.reports.available.academic.desc", "بررسی جامع تحصیلی شامل نمرات، روند معدل و عملکرد در دروس");
    m.insert("parent.reports.available.attendance.title", "گزارش حضور و غیاب");
    m.insert("parent.reports.available.attendance.desc", "سوابق دقیق حضور و غیاب شامل غیبت‌ها، تاخیرها و الگوها");
    m.insert("parent.reports.available.behavior.title", "گزارش انضباطی");
    m.insert("parent.reports.available.behavior.desc", "ارزیابی‌های انضباطی، سوابق رفتاری و بازخورد معلمان");
    m.insert("parent.reports.available.standardized.title", "آزمون‌های استاندارد");
    m.insert("parent.reports.available.standardized.desc", "نمرات آزمون‌های استاندارد و پیگیری پیشرفت");
    ...
    m.insert("school_manager.settings.description", "مدیریت تنظیمات حساب و موسسه");
    ...
    m.insert("school_manager.settings.general.loading", "در حال بارگذاری ترجیحات...");
    ...
    m.insert("school_manager.settings.general.success", "موفقیت! تنظیمات ذخیره شد.");
    m.insert("school_manager.settings.general.error", "خطا: {0}");

    // Timezone Options
    m.insert("school_manager.settings.general.timezone.utc", "هماهنگ جهانی (UTC)");
    m.insert("school_manager.settings.general.timezone.et", "وقت شرقی (ET)");
    m.insert("school_manager.settings.general.timezone.ct", "وقت مرکزی (CT)");
    m.insert("school_manager.settings.general.timezone.mt", "وقت کوهستانی (MT)");
    m.insert("school_manager.settings.general.timezone.pt", "وقت اقیانوس آرام (PT)");
    m.insert("school_manager.settings.general.timezone.gmt", "لندن (GMT)");
    m.insert("school_manager.settings.general.timezone.cet", "پاریس (CET)");
    m.insert("school_manager.settings.general.timezone.jst", "توکیو (JST)");
    m.insert("school_manager.settings.general.timezone.gst", "دبی (GST)");
    m.insert("school_manager.settings.general.timezone.aedt", "سیدنی (AEDT)");

    // Time Format Options
    m.insert("school_manager.settings.general.time_format.24h", "۲۴ ساعته (۱۴:۳۰)");
    m.insert("school_manager.settings.general.time_format.12h", "۱۲ ساعته (۲:۳۰ ب.ظ)");

    // Notification Settings
    m.insert("school_manager.settings.notifications.title", "ترجیحات اعلان‌ها");
    m.insert("school_manager.settings.notifications.loading", "در حال بارگذاری ترجیحات...");
    m.insert("school_manager.settings.notifications.channels", "کانال‌های اعلان");
    ...
    m.insert("school_manager.settings.notifications.save_btn", "ذخیره ترجیحات");
    m.insert("school_manager.settings.notifications.success", "موفقیت! ترجیحات ذخیره شد.");
    ...
    m.insert("school_manager.settings.profile.loading", "در حال بارگذاری پروفایل...");
    ...
    m.insert("school_manager.settings.profile.updated", "پروفایل بروزرسانی شد");
    m.insert("school_manager.settings.profile.role_admin", "مدیر سیستم");
    m.insert("school_manager.settings.profile.actions_title", "عملیات پروفایل");
    m.insert("school_manager.settings.profile.request_change", "درخواست تغییر پروفایل");
    m.insert("school_manager.settings.profile.change_pwd", "تغییر رمز عبور");
    m.insert("school_manager.settings.profile.pwd_requirements", "الزامات رمز عبور:");
    m.insert("school_manager.settings.profile.pwd_req_1", "حداقل ۸ کاراکتر");
    m.insert("school_manager.settings.profile.pwd_req_2", "حداقل یک حرف بزرگ");
    m.insert("school_manager.settings.profile.pwd_req_3", "حداقل یک عدد");
    m.insert("school_manager.settings.profile.pwd_coming_soon", "قابلیت تغییر رمز عبور به زودی. در حال حاضر از طریق ارائه دهنده احراز هویت مدیریت می‌شود.");
    m.insert("school_manager.settings.profile.request_submitted", "درخواست ارسال شد");
    m.insert("school_manager.settings.profile.log.updated", "پروفایل بروزرسانی شد");
    m.insert("school_manager.settings.profile.log.submitted", "درخواست ثبت شد");
    
    m.insert("school_manager.settings.notifications.email", "اعلان‌های ایمیلی");
    m.insert("school_manager.settings.notifications.push", "اعلان‌های پوش");
    m.insert("school_manager.settings.notifications.in_app", "اعلان‌های درون‌برنامه");
    
    m.insert("school_manager.settings.notifications.user_reg", "ثبت‌نام کاربر");
    m.insert("school_manager.settings.notifications.user_reg_desc", "اعلان هنگام پیوستن کاربر جدید به سیستم");
    m.insert("school_manager.settings.notifications.class_created", "ایجاد کلاس");
    m.insert("school_manager.settings.notifications.class_created_desc", "اعلان هنگام ایجاد کلاس جدید");
    m.insert("school_manager.settings.notifications.assignment", "ارسال تکلیف");
    m.insert("school_manager.settings.notifications.assignment_desc", "اعلان هنگام ارسال تکلیف توسط دانش‌آموزان");
    m.insert("school_manager.settings.notifications.report", "تولید گزارش");
    m.insert("school_manager.settings.notifications.report_desc", "اعلان هنگام تولید گزارش دانش‌آموز");
    m.insert("school_manager.settings.notifications.profile_change", "درخواست تغییر پروفایل");
    m.insert("school_manager.settings.notifications.profile_change_desc", "اعلان هنگام ارسال درخواست تغییر پروفایل");
    m.insert("school_manager.settings.notifications.announcements", "اعلانات سیستم");
    m.insert("school_manager.settings.notifications.announcements_desc", "دریافت بروزرسانی‌های مهم سیستم");
    
    m.insert("school_manager.settings.notifications.digest.never", "هرگز");
    m.insert("school_manager.settings.notifications.digest.daily", "خلاصه روزانه");
    m.insert("school_manager.settings.notifications.digest.weekly", "خلاصه هفتگی");

    // Security Settings
    m.insert("school_manager.settings.security.title", "تغییر رمز عبور");
    m.insert("school_manager.settings.security.current_pwd", "رمز عبور فعلی");
    m.insert("school_manager.settings.security.new_pwd", "رمز عبور جدید");
    m.insert("school_manager.settings.security.confirm_pwd", "تأیید رمز عبور جدید");
    m.insert("school_manager.settings.security.update_btn", "بروزرسانی رمز عبور");
    m.insert("school_manager.settings.security.mismatch", "رمزهای عبور جدید مطابقت ندارند");
    m.insert("school_manager.settings.security.min_length", "رمز عبور باید حداقل ۸ کاراکتر باشد");
    m.insert("school_manager.settings.security.success", "رمز عبور با موفقیت تغییر کرد");
    m.insert("school_manager.settings.security.failure", "خطا در تغییر رمز عبور");

    // User Creation Hub
    m.insert("school_manager.users.creation.title", "مرکز ایجاد کاربر");
    m.insert("school_manager.users.creation.subtitle", "ایجاد و مدیریت حساب‌های دانش‌آموز، معلم و والدین");
    ...
    m.insert("school_manager.users.creation.academic_info", "اطلاعات تحصیلی");
    m.insert("school_manager.users.creation.professional_info", "اطلاعات شغلی");
    m.insert("school_manager.users.creation.class_assignment", "تخصیص کلاس");
    m.insert("school_manager.users.creation.student_association", "ارتباط با دانش‌آموز");
    ...
    m.insert("school_manager.users.creation.student_id", "شناسه دانش‌آموزی *");
    m.insert("school_manager.users.creation.grade_level", "پایه تحصیلی *");
    m.insert("school_manager.users.creation.enrollment_date", "تاریخ ثبت‌نام *");
    m.insert("school_manager.users.creation.class_section", "کلاس/بخش");
    m.insert("school_manager.users.creation.academic_year", "سال تحصیلی *");
    m.insert("school_manager.users.creation.employee_id", "شناسه کارمندی *");
    ...
    m.insert("school_manager.users.creation.qualifications", "مدارک و گواهینامه‌ها");
    m.insert("school_manager.users.creation.assign_classes", "تخصیص کلاس‌ها");
    m.insert("school_manager.users.creation.parent_id", "شناسه والدین *");
    m.insert("school_manager.users.creation.relationship", "نسبت *");
    m.insert("school_manager.users.creation.associated_students", "دانش‌آموزان مرتبط *");
    ...
    m.insert("school_manager.users.creation.subjects.biology", "زیست‌شناسی");
    m.insert("school_manager.users.creation.subjects.english", "ادبیات انگلیسی");
    ...
    m.insert("school_manager.users.creation.placeholders.first_name", "نام را وارد کنید");
    m.insert("school_manager.users.creation.placeholders.last_name", "نام خانوادگی را وارد کنید");
    m.insert("school_manager.users.creation.placeholders.full_name", "نام کامل را وارد کنید");
    m.insert("school_manager.users.creation.placeholders.relationship", "نسبت را وارد کنید (مثلاً پدر)");
    ...
    m.insert("school_manager.users.creation.placeholders.employee_id", "TCH001234");
    m.insert("school_manager.users.creation.placeholders.parent_id", "PAR001234");
    m.insert("school_manager.users.creation.placeholders.qualifications", "لیست مدارک، گواهینامه‌ها و صلاحیت‌ها...");
    
    m.insert("school_manager.users.creation.btn.create_student", "ایجاد حساب دانش‌آموز");
    m.insert("school_manager.users.creation.btn.create_teacher", "ایجاد حساب معلم");
    m.insert("school_manager.users.creation.btn.create_parent", "ایجاد حساب والدین");
    
    m.insert("school_manager.users.creation.options.select_grade", "انتخاب پایه تحصیلی");
    m.insert("school_manager.users.creation.options.select_section", "انتخاب بخش");
    m.insert("school_manager.users.creation.options.select_dept", "انتخاب دپارتمان");
    m.insert("school_manager.users.creation.options.loading_classes", "در حال بارگذاری کلاس‌ها...");
    m.insert("school_manager.users.creation.options.loading_students", "در حال بارگذاری دانش‌آموزان...");
    
    m.insert("school_manager.users.creation.success.student", "دانش‌آموز با موفقیت ایجاد شد! رمز عبور موقت: {0}");
    m.insert("school_manager.users.creation.success.teacher", "معلم با موفقیت ایجاد شد! رمز عبور موقت: {0}");
    m.insert("school_manager.users.creation.success.parent", "حساب والدین با موفقیت ایجاد شد. رمز عبور موقت: {0}");
    m.insert("school_manager.users.creation.error.parent", "خطا در ایجاد والدین: {0}");
    
    m.insert("school_manager.users.creation.stats.title", "آمار فعلی");
    m.insert("school_manager.users.creation.tips.title", "نکات سریع");
    m.insert("school_manager.users.creation.activity.title", "فعالیت‌های اخیر");
    ...
    m.insert("school_manager.access_denied_desc", "شما اجازه دسترسی به داشبورد مدیر مدرسه را ندارید.");
    m.insert("school_manager.go_to_dashboard", "برو به داشبورد خودتان");
    
    m.insert("school_manager.users.title", "مدیریت کاربران");
    m.insert("school_manager.users.description", "مدیریت دانش‌آموزان، معلمان و والدین در موسسه شما");
    ...
    m.insert("school_manager.users.manage_btn.students", "مدیریت دانش‌آموزان");
    ...
    m.insert("school_manager.users.actions.bulk_import", "وارد کردن گروهی");
    m.insert("school_manager.users.actions.export_users", "خروجی گرفتن کاربران");
    
    m.insert("school_manager.users.directory.title", "فهرست کاربران");
    m.insert("school_manager.users.directory.search_placeholder", "جستجوی کاربران...");
    ...
    m.insert("school_manager.users.messages.deactivate_success", "کاربر با موفقیت غیرفعال شد");
    m.insert("school_manager.users.messages.deactivate_fail", "خطا در غیرفعال کردن کاربر: ");
    m.insert("school_manager.users.messages.reactivate_success", "کاربر با موفقیت فعال شد");
    m.insert("school_manager.users.messages.reactivate_fail", "خطا در فعال کردن کاربر: ");
    m.insert("school_manager.users.messages.update_success", "اطلاعات کاربر با موفقیت بروزرسانی شد");
    m.insert("school_manager.users.messages.update_fail", "خطا در بروزرسانی کاربر: ");
    m.insert("school_manager.users.messages.load_error", "خطا در بارگذاری کاربران: {e}");
    ...
    m.insert("school_manager.users.import_modal.title", "وارد کردن گروهی کاربران");
    m.insert("school_manager.users.import_modal.csv_title", "فرمت CSV مورد نیاز");
    m.insert("school_manager.users.import_modal.csv_desc", "یک فایل CSV با ستون‌های: name, email, role آپلود کنید");
    m.insert("school_manager.users.import_modal.drop_text", "فایل CSV خود را اینجا رها کنید");
    m.insert("school_manager.users.import_modal.browse_text", "یا برای انتخاب فایل کلیک کنید");
    m.insert("school_manager.users.import_modal.coming_soon", "قابلیت وارد کردن گروهی به زودی فعال می‌شود. لطفاً فعلاً کاربران را به صورت تکی اضافه کنید.");
    m.insert("school_manager.users.import_modal.import_btn", "وارد کردن");
    
    m.insert("school_manager.users.export_modal.title", "خروجی گرفتن کاربران");
    m.insert("school_manager.users.export_modal.format_label", "فرمت خروجی");
    m.insert("school_manager.users.export_modal.options_label", "گزینه‌ها");
    m.insert("school_manager.users.export_modal.include_inactive", "شامل کاربران غیرفعال");
    m.insert("school_manager.users.export_modal.coming_soon", "قابلیت خروجی گرفتن به زودی فعال می‌شود.");
    m.insert("school_manager.users.export_modal.export_btn", "خروجی گرفتن");

    m.insert("classes.not_enrolled", "در هیچ کلاسی ثبت‌نام نشده‌اید");

    m.insert("classes.view_description", "کلاس‌های ثبت‌نام‌شده و منابع کلاس خود را مشاهده کنید");
    m
}
    ...
    fn test_all_fa_keys_present() {
        ...
        for key in en_translations.keys() {
            assert!(
                ...
                "Missing Farsi translation for key: {}", key
            );
        }
    }
}
