...
pub(crate) fn platform_admin_translation(
    ...
    match (locale, key) {
        ...
        (Locale::En, "platform_admin.ocr.verification_details") => Some("Verification details"),
        (Locale::Fa, "platform_admin.ocr.verification_details") => Some("جزئیات تأیید"),
...
mod tests {
    ...
    const KEYS: &[&str] = &[
        ...
        "platform_admin.ocr.verification_details",
