...
INSERT INTO assignments(id,teacher_id,class_section_id,title,body,due_at,status) VALUES('f0600000-0000-0000-0000-000000000101','c0000000-0000-0000-0000-0000000000a2','e0000000-0000-0000-0000-0000000000a1','E2E Attachment 101','Submit your work.',NOW()+INTERVAL '14 days','Published') ON CONFLICT DO NOTHING;
...
INSERT INTO assignments(id,teacher_id,class_section_id,title,body,due_at,status) VALUES('f0600000-0000-0000-0000-000000000102','c0000000-0000-0000-0000-0000000000a2','e0000000-0000-0000-0000-0000000000a1','E2E Attachment 102','Submit your work.',NOW()+INTERVAL '14 days','Published') ON CONFLICT DO NOTHING;
...
INSERT INTO assignments(id,teacher_id,class_section_id,title,body,due_at,status) VALUES('f0600000-0000-0000-0000-000000000103','c0000000-0000-0000-0000-0000000000a2','e0000000-0000-0000-0000-0000000000a1','E2E Attachment 103','Submit your work.',NOW()+INTERVAL '14 days','Published') ON CONFLICT DO NOTHING;
...
INSERT INTO assignments(id,teacher_id,class_section_id,title,body,due_at,status) VALUES('f0600000-0000-0000-0000-000000000104','c0000000-0000-0000-0000-0000000000a2','e0000000-0000-0000-0000-0000000000a1','E2E Attachment 104','Submit your work.',NOW()+INTERVAL '14 days','Published') ON CONFLICT DO NOTHING;
...
INSERT INTO assignments(id,teacher_id,class_section_id,title,body,due_at,status) VALUES('f0600000-0000-0000-0000-000000000190','c0000000-0000-0000-0000-0000000000a2','e0000000-0000-0000-0000-0000000000a1','E2E Attachment 190','Submit your work.',NOW()+INTERVAL '14 days','Published') ON CONFLICT DO NOTHING;
...
INSERT INTO assignments(id,teacher_id,class_section_id,title,body,due_at,status) VALUES('f0600000-0000-0000-0000-000000000201','c0000000-0000-0000-0000-0000000000a2','e0000000-0000-0000-0000-0000000000a1','E2E Attachment 201','Submit your work.',NOW()+INTERVAL '14 days','Published') ON CONFLICT DO NOTHING;
...
INSERT INTO assignments(id,teacher_id,class_section_id,title,body,due_at,status) VALUES('f0600000-0000-0000-0000-000000000202','c0000000-0000-0000-0000-0000000000a2','e0000000-0000-0000-0000-0000000000a1','E2E Attachment 202','Submit your work.',NOW()+INTERVAL '14 days','Published') ON CONFLICT DO NOTHING;
...
INSERT INTO assignments(id,teacher_id,class_section_id,title,body,due_at,status) VALUES('f0600000-0000-0000-0000-000000000203','c0000000-0000-0000-0000-0000000000a2','e0000000-0000-0000-0000-0000000000a1','E2E Attachment 203','Submit your work.',NOW()+INTERVAL '14 days','Published') ON CONFLICT DO NOTHING;
...
INSERT INTO assignments(id,teacher_id,class_section_id,title,body,due_at,status) VALUES('f0600000-0000-0000-0000-000000000204','c0000000-0000-0000-0000-0000000000a2','e0000000-0000-0000-0000-0000000000a1','E2E Attachment 204','Submit your work.',NOW()+INTERVAL '14 days','Published') ON CONFLICT DO NOTHING;
...
INSERT INTO assignments(id,teacher_id,class_section_id,title,body,due_at,status) VALUES('f0600000-0000-0000-0000-000000000290','c0000000-0000-0000-0000-0000000000a2','e0000000-0000-0000-0000-0000000000a1','E2E Attachment 290','Submit your work.',NOW()+INTERVAL '14 days','Published') ON CONFLICT DO NOTHING;
