...
INSERT INTO assignments(id,teacher_id,class_section_id,subject_id,title,body,due_at,status,published_at) VALUES('f0600000-0000-0000-0000-000000000101','c0000000-0000-0000-0000-0000000000a2','e0000000-0000-0000-0000-0000000000a1','d0000000-0000-0000-0000-0000000000a1','E2E Attachment 101','Submit your work.',NOW()+INTERVAL '14 days','Published',NOW()) ON CONFLICT DO NOTHING;
INSERT INTO custom_assignments(id,assignment_id,student_id,due_at,status) VALUES('f1600000-0000-0000-0000-000000000101','f0600000-0000-0000-0000-000000000101','c0000000-0000-0000-0000-0000000000a3',NOW()+INTERVAL '14 days','Assigned') ON CONFLICT DO NOTHING;
INSERT INTO assignments(id,teacher_id,class_section_id,subject_id,title,body,due_at,status,published_at) VALUES('f0600000-0000-0000-0000-000000000102','c0000000-0000-0000-0000-0000000000a2','e0000000-0000-0000-0000-0000000000a1','d0000000-0000-0000-0000-0000000000a1','E2E Attachment 102','Submit your work.',NOW()+INTERVAL '14 days','Published',NOW()) ON CONFLICT DO NOTHING;
INSERT INTO custom_assignments(id,assignment_id,student_id,due_at,status) VALUES('f1600000-0000-0000-0000-000000000102','f0600000-0000-0000-0000-000000000102','c0000000-0000-0000-0000-0000000000a3',NOW()+INTERVAL '14 days','Assigned') ON CONFLICT DO NOTHING;
INSERT INTO assignments(id,teacher_id,class_section_id,subject_id,title,body,due_at,status,published_at) VALUES('f0600000-0000-0000-0000-000000000103','c0000000-0000-0000-0000-0000000000a2','e0000000-0000-0000-0000-0000000000a1','d0000000-0000-0000-0000-0000000000a1','E2E Attachment 103','Submit your work.',NOW()+INTERVAL '14 days','Published',NOW()) ON CONFLICT DO NOTHING;
INSERT INTO custom_assignments(id,assignment_id,student_id,due_at,status) VALUES('f1600000-0000-0000-0000-000000000103','f0600000-0000-0000-0000-000000000103','c0000000-0000-0000-0000-0000000000a3',NOW()+INTERVAL '14 days','Assigned') ON CONFLICT DO NOTHING;
INSERT INTO assignments(id,teacher_id,class_section_id,subject_id,title,body,due_at,status,published_at) VALUES('f0600000-0000-0000-0000-000000000104','c0000000-0000-0000-0000-0000000000a2','e0000000-0000-0000-0000-0000000000a1','d0000000-0000-0000-0000-0000000000a1','E2E Attachment 104','Submit your work.',NOW()+INTERVAL '14 days','Published',NOW()) ON CONFLICT DO NOTHING;
INSERT INTO custom_assignments(id,assignment_id,student_id,due_at,status) VALUES('f1600000-0000-0000-0000-000000000104','f0600000-0000-0000-0000-000000000104','c0000000-0000-0000-0000-0000000000a3',NOW()+INTERVAL '14 days','Assigned') ON CONFLICT DO NOTHING;
INSERT INTO assignments(id,teacher_id,class_section_id,subject_id,title,body,due_at,status,published_at) VALUES('f0600000-0000-0000-0000-000000000190','c0000000-0000-0000-0000-0000000000a2','e0000000-0000-0000-0000-0000000000a1','d0000000-0000-0000-0000-0000000000a1','E2E Attachment 190','Submit your work.',NOW()+INTERVAL '14 days','Published',NOW()) ON CONFLICT DO NOTHING;
INSERT INTO custom_assignments(id,assignment_id,student_id,due_at,status) VALUES('f1600000-0000-0000-0000-000000000190','f0600000-0000-0000-0000-000000000190','c0000000-0000-0000-0000-0000000000a3',NOW()+INTERVAL '14 days','Assigned') ON CONFLICT DO NOTHING;
INSERT INTO assignments(id,teacher_id,class_section_id,subject_id,title,body,due_at,status,published_at) VALUES('f0600000-0000-0000-0000-000000000201','c0000000-0000-0000-0000-0000000000a2','e0000000-0000-0000-0000-0000000000a1','d0000000-0000-0000-0000-0000000000a1','E2E Attachment 201','Submit your work.',NOW()+INTERVAL '14 days','Published',NOW()) ON CONFLICT DO NOTHING;
INSERT INTO custom_assignments(id,assignment_id,student_id,due_at,status) VALUES('f1600000-0000-0000-0000-000000000201','f0600000-0000-0000-0000-000000000201','c0000000-0000-0000-0000-0000000000a3',NOW()+INTERVAL '14 days','Assigned') ON CONFLICT DO NOTHING;
INSERT INTO assignments(id,teacher_id,class_section_id,subject_id,title,body,due_at,status,published_at) VALUES('f0600000-0000-0000-0000-000000000202','c0000000-0000-0000-0000-0000000000a2','e0000000-0000-0000-0000-0000000000a1','d0000000-0000-0000-0000-0000000000a1','E2E Attachment 202','Submit your work.',NOW()+INTERVAL '14 days','Published',NOW()) ON CONFLICT DO NOTHING;
INSERT INTO custom_assignments(id,assignment_id,student_id,due_at,status) VALUES('f1600000-0000-0000-0000-000000000202','f0600000-0000-0000-0000-000000000202','c0000000-0000-0000-0000-0000000000a3',NOW()+INTERVAL '14 days','Assigned') ON CONFLICT DO NOTHING;
INSERT INTO assignments(id,teacher_id,class_section_id,subject_id,title,body,due_at,status,published_at) VALUES('f0600000-0000-0000-0000-000000000203','c0000000-0000-0000-0000-0000000000a2','e0000000-0000-0000-0000-0000000000a1','d0000000-0000-0000-0000-0000000000a1','E2E Attachment 203','Submit your work.',NOW()+INTERVAL '14 days','Published',NOW()) ON CONFLICT DO NOTHING;
INSERT INTO custom_assignments(id,assignment_id,student_id,due_at,status) VALUES('f1600000-0000-0000-0000-000000000203','f0600000-0000-0000-0000-000000000203','c0000000-0000-0000-0000-0000000000a3',NOW()+INTERVAL '14 days','Assigned') ON CONFLICT DO NOTHING;
INSERT INTO assignments(id,teacher_id,class_section_id,subject_id,title,body,due_at,status,published_at) VALUES('f0600000-0000-0000-0000-000000000204','c0000000-0000-0000-0000-0000000000a2','e0000000-0000-0000-0000-0000000000a1','d0000000-0000-0000-0000-0000000000a1','E2E Attachment 204','Submit your work.',NOW()+INTERVAL '14 days','Published',NOW()) ON CONFLICT DO NOTHING;
INSERT INTO custom_assignments(id,assignment_id,student_id,due_at,status) VALUES('f1600000-0000-0000-0000-000000000204','f0600000-0000-0000-0000-000000000204','c0000000-0000-0000-0000-0000000000a3',NOW()+INTERVAL '14 days','Assigned') ON CONFLICT DO NOTHING;
INSERT INTO assignments(id,teacher_id,class_section_id,subject_id,title,body,due_at,status,published_at) VALUES('f0600000-0000-0000-0000-000000000290','c0000000-0000-0000-0000-0000000000a2','e0000000-0000-0000-0000-0000000000a1','d0000000-0000-0000-0000-0000000000a1','E2E Attachment 290','Submit your work.',NOW()+INTERVAL '14 days','Published',NOW()) ON CONFLICT DO NOTHING;
INSERT INTO custom_assignments(id,assignment_id,student_id,due_at,status) VALUES('f1600000-0000-0000-0000-000000000290','f0600000-0000-0000-0000-000000000290','c0000000-0000-0000-0000-0000000000a3',NOW()+INTERVAL '14 days','Assigned') ON CONFLICT DO NOTHING;
COMMIT;
